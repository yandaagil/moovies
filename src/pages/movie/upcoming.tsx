...
import { getUpcomingMovieList } from "@/server/api";
...
export default function Home() {
  ...
  const handleLoadMore = async () => {
    ...
    const newMovies = await getUpcomingMovieList(newPage);
    setPage(newPage);
    setUpcomingMovies((prevItems) => [...prevItems, ...newMovies]);
  }
  ...
  return (
    <>
      ...
      <div className="mt-5">
        ...
        {/* title */}
        <h1 className="text-2xl font-bold text-foreground md:text-3xl">Upcoming</h1>
