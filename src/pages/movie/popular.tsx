...
import { getPopularMovieList } from "@/server/api";
...
export default function Home() {
  ...
  const handleLoadMore = async () => {
    ...
    const newMovies = await getPopularMovieList(newPage);
    setPage(newPage);
    setPopularMovies((prevItems) => [...prevItems, ...newMovies]);
  }
  ...
  return (
    <>
      ...
      <div className="mt-5">
        ...
        {/* title */}
        <h1 className="text-2xl font-bold text-foreground md:text-3xl">Popular</h1>
